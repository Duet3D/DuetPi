...
if (move.axes[0].homed = false || move.axes[1].homed = false)
	...
	G28 X
    G92 C60
G0 X{global.xPT3Position + tools[3].offsets[0]}  Y{move.axes[1].min} F5000  
M400
M564 H0 S0
G0 X{global.xPT3Position + tools[3].offsets[0]}  Y{move.axes[1].min - global.yPT3Position + 11} F5000
M400
