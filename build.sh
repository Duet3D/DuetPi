...
export WPA_COUNTRY="IT"
export ENABLE_SSH="${ENABLE_SSH:-1}"
export PUBKEY_ONLY_SSH="${PUBKEY_ONLY_SSH:-0}"

export LOCALE_DEFAULT="${LOCALE_DEFAULT:-it_IT.UTF-8}"

export KEYBOARD_KEYMAP="${KEYBOARD_KEYMAP:-it}"
export KEYBOARD_LAYOUT="${KEYBOARD_LAYOUT:-Italian}"
